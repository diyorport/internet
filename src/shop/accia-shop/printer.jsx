...
import prin_1 from '../../img/printer/prin-1.jpg'
import prin_2 from '../../img/printer/prin-3.jpg'
import prin_3 from '../../img/printer/prin-4.jpg'
import prin_4 from '../../img/printer/prin-5.jpg'
import prin_5 from '../../img/printer/prin-6.jpg'
import prin_6 from '../../img/printer/prin-7.jpg'
import prin_7 from '../../img/printer/prin-8.jpg'
import prin_8 from '../../img/printer/prin-9.jpg'
import prin_9 from '../../img/printer/prin-10.jpg'
import prin_10 from '../../img/printer/prin-11.jpg'
                ...
                <section className='main__phone main__prin'>
                    ...
                    <div className="main__section__boxs">
                        <div className="main__section__box">
                            ...
                            Printer Canon MAXIFY GX4040 (5779C009AA) 
                            </h3>
                        ...
                        <div className="main__section__box ">
                            ...
                            Printer Canon MAXIFY GX3040 (5777C009AA) 
                            </h3>
                        ...
                        <div className="main__section__box main__section__boxr">
                            ...
                            <h3 className='main__phone__box__name'>
                            Printer Canon i-SENSYS MF651Cw EMEA (5158C009AA) 
                            </h3>
                        ...
                        <div className="main__section__box ">
                            ...
                            <h3 className='main__phone__box__name class__name'>
                            Printer Canon i-SENSYS MF655Cdw EMEA, ADF (5158C004AA) 
                            </h3>
                    ...
                    <div className="main__section__boxs">
                        <div className="main__section__box main__section__boxr">
                            ...
                            <h3 className='main__phone__box__name'>
                            Printer Canon i-SENSYS MF657Cdw CIS, DADF (5158C014AA) 
                            </h3>
                        ...
                        <div className="main__section__box main__section__boxr">
                            ...
                            <h3 className='main__phone__box__name'>
                            Printer MFU Canon i-SENSYS MF752Cdw (5455C012AA) 
                            </h3>
                    ...
                    <div className="main__section__boxs">
                        ...
                        <div className="main__section__box main__section__boxr">
                            <div className="main__section__img">
                                ...
                                <svg className='main__phone__svg__icon zxc' xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" /></svg>
                            </div>
                            <h3 className='main__phone__box__name'>
                            Yo‘q qiluvchi qoplar Fellowes FS-36052 
                            </h3>
